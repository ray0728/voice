...
public class CameraHelper {
    ...
    public interface CameraListener {
        ...
        void onPreview(byte[] y, byte[] u, byte[] v);
        void onCameraClosed();
...
//        }
    ...
    private int getCameraOri(int rotation, String cameraId) {
        ...
        Log.d(TAG, "getCameraOri: " + rotation + " " + result + " " + mSensorOrientation);
        return result;
    }
    ...
    private CameraDevice.StateCallback mDeviceStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice cameraDevice) {
            ...
            if (mCameraListener != null) {
                mCameraListener.onCameraOpened(cameraDevice, mCameraId, mPreviewSize, getCameraOri(rotation, mCameraId), isMirror);
            }
        }
...
//        }
//        Log.d(TAG, "configureTransform: " + getCameraOri(rotation, mCameraId) + "  " + rotation * 90);
...
//        private TextureView previewDisplayView;
    ...
    private class OnImageAvailableListenerImpl implements ImageReader.OnImageAvailableListener {
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            // Y:U:V == 4:2:2
            if (mCameraListener != null && image.getFormat() == ImageFormat.YUV_420_888) {
                    ...
                    switch (i) {
                        case 0:
                            for (int j = 0; j < height; j++) {
                                System.arraycopy(bytes, srcIndex, y, dstIndex, width);
                                srcIndex += rowStride;
                                dstIndex += width;
                            }
                            break;
                ...
                lock.unlock();
                mCameraListener.onPreview(y,u,v);
            }
            image.close();
        }
    }
